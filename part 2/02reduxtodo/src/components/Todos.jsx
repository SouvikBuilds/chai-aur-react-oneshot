          ...
          >
            <div
              className={`px-2 py-1 rounded ${
                todo.completed
                  ? "bg-green-600 line-through text-white"
                  : "text-white"
              }`}
            >
              {todo.text}
              ...
              >
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M16.862 4.487l1.651 1.651a2 2 0 010 2.828l-8.49 8.49a4 4 0 01-1.414.943l-3.26 1.086a.5.5 0 01-.633-.633l1.086-3.26a4 4 0 01.943-1.414l8.49-8.49a2 2 0 012.828 0z"
                  />
                </svg>
              </button>
